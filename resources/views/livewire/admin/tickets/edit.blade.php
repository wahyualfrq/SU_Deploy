<div class="p-6 max-w-3xl">
    <div class="mb-5">
        ...
        <p class="text-sm text-gray-500">
            Perbarui kategori, harga, stok, dan status tiket.
        </p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-5 space-y-4">
        ...
        <div>
            ...
            <select wire:model="match_id" class="mt-1 w-full px-4 py-2 rounded-lg border border-gray-200
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input wire:model="price" type="number" min="0" class="mt-1 w-full px-4 py-2 rounded-lg border border-gray-200
                           focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 outline-none">
                @error('price')
                    <div class="text-xs text-red-600 mt-1">{{ $message }}</div>
                @enderror
            ...
            <div>
                ...
                <input wire:model="stock" type="number" min="0" class="mt-1 w-full px-4 py-2 rounded-lg border border-gray-200
                           focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 outline-none">
                @error('stock')
                    <div class="text-xs text-red-600 mt-1">{{ $message }}</div>
                @enderror
